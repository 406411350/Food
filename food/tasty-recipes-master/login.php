...
<body>
    ...
    <!-- header-start -->                                 <form action="loginprocess.php" method="post">
    <header>
      ...
      <div class="row">
        ...
        <aside class="single_sidebar_widget newsletter_widget">
                                ...
                                <div class="form-group">
                                   ...
                                   <input type="index" name="account" class="form-control" onfocus="this.placeholder = ''"
                                ...
                                <button class="btn btn-outline-danger " style="margin-right:158px;" type="submit" >使用者登入</button> 
            <a class="btn btn-outline-success " style="margin-right:10px;" href="mg_login.php">切換身分</a>
                             </div>  </form>     
          <a href="register.php"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
