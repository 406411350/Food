...
<body>
    ...
    if ($v==5){
        ...
        break;
			                	...
			                	<a href="buy1.php?id=5" class="mt-2"><i class="ti-shopping-cart mr-2 text-primary"></i></a>
    ...
    if ($v==6){
        ...
        break;
                                     ...
                                     <input type="text" name="qty" style=width:20px;height:15px>
			                	<a href="buy1.php?id=6" class="mt-2"><i class="ti-shopping-cart mr-2 text-primary"></i></a>
    ...
    if ($v==7){
        ...
        break;
                                    ...
                                    <input type="text" name="qty" style=width:20px;height:15px>
			                	<a href="buy1.php?id=7" class="mt-2"><i class="ti-shopping-cart mr-2 text-primary"></i></a>
    ...
    if ($v==8){
        ...
        break;
                                     ...
                                     <input type="text" name="qty" style=width:20px;height:15px>
			                	<a href="buy1.php?id=8" class="mt-2"><i class="ti-shopping-cart mr-2 text-primary"></i></a>
