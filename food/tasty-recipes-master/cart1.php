 ...
 <?php
  ...
  <tr>
    <td><center><?php echo $v[1]; ?> </center></td>
      <td ><center><a href="countplus1.php?c=<?php echo $v[0]; ?>"><img src="img/%E5%8A%A0.jpg" width="15" border="0"></a><a href="count1.php?c=<?php echo $v[0] ?>"><img src="img/%E6%B8%9B.jpg" width="15" border="0"></a>&nbsp;&nbsp;&nbsp;<?php echo $v[2]; ?></center></td>
    <td ><center><?php echo $v[3]; ?></center></td>
      <td ><center><a href="delete1.php?de=<?php echo $v[0]; ?>"><img src="img/垃圾桶.jpg"width="25" height="25" alt=""></a></center></td>
  </tr>
  <?php
        }
        ?>
			...
			<div class="section-top-border">
				<div class="row">
					...
					<div class="col-lg-3 col-md-4 mt-sm-30">
						...
						<div class="button-group-area mt-40" >
						<a href="心園menu.php" class="genric-btn success circle arrow" >繼續點餐<span class="lnr lnr-arrow-right"></span></a>
						</div>						
						</div>
